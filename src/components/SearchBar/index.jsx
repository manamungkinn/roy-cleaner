    ...
    <div className="px-2 lg:px-4 w-full">
      <div className="flex items-center max-w-md lg:mx-auto ml-auto">
        <input
          ...
          className="text-main-accent w-full py-1 px-4 border border-gray-300 rounded-l-md shadow-sm focus:outline-none focus:ring-.5 focus:ring-main-accent focus:border-main-accent"
        />
